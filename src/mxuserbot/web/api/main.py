...
from ...web.api.controllers import AuthController, ModuleController, PageController, RepoController, SystemController
...
def build_routers(
    ...
    AuthController(context, deps).register(router)

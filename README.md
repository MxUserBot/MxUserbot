...
<table cellspacing="0" width="100%">
 <tr>
  <td width="100%" style="border:1px solid #30363d;padding:0;vertical-align:top"><div style="padding:12px;border-bottom:1px solid #30363d"><b>Rate Limiter</b> - AIMD-based protection against "Too Many Requests" allows you to run your userbot on any server!.</div><img src="assets/promo/RATE_LIMITER.png" width="100%" style="display:block"></td>
 </tr>
</table>
